define(
    ...
    function(dom, request, domConstruct, Menu, MenuItem, MenuBar, MenuBarItem, PopupMenuBarItem, Dialog, HorizontalSlider, Button){
        ...
        var menu;
        var brightnessContrastDialog = null;
        var oldImageData = [];
      ...
      var adjustBrightness = function(brightness)
      {
        ...
        var createBrightnessContrastDialog = function()
        {
        ...
        return {
            ...
            create: function(id) {
                ...
                menu.addChild(new MenuItem({
                    ...
                    {
                      saveBrightness();
                      if (brightnessContrastDialog == null)
                      {
                        brightnessContrastDialog = createBrightnessContrastDialog();
                      }
